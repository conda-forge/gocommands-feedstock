...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/gocommands-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/gocommands-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install gocommands
```
...
It is possible to list all of the versions of `gocommands` available on your platform:
...
```
pixi search gocommands --channel conda-forge
```
